...
import { Loader2, CheckCircle2, ArrowRight, AlertCircle, FileText, Upload, Trash2 } from "lucide-react";
                      ...
                      {q.options.map((opt, i) => (
                        <label 
                          ...
                          className={cn(
                            ...
                            val === opt ? "bg-indigo-600/10 border-indigo-500 text-indigo-100" : "bg-[#0f111a] border-white/5 hover:border-white/10 text-slate-300"
                          )}
                        >
                          <input 
                            type="radio" 
                            ...
                            className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-white/20 bg-transparent"
                          />
