...
export function UserConfigurationModal({ open, onClose, onSuccess, pendingUser }: UserConfigurationModalProps) {
  ...
  return (
    <Modal
      ...
      title=""
      size="xl"
      className="max-w-4xl bg-[#0a0a0f] border border-violet-500/15 shadow-xl shadow-violet-950/40"
    >
      <Modal.Header 
        title={
      ...
      <Modal.Body className="p-8 space-y-8 custom-scrollbar">
        ...
        {pendingUser && (
          <div className="p-6 rounded-2xl bg-[#1e1b2e] border border-violet-500/15 flex items-center justify-between shadow-inner shadow-violet-950/20 animate-in fade-in slide-in-from-top-4">
            <div className="flex items-center gap-4">
              <div className="h-14 w-14 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-xl font-bold text-white shadow-lg ring-2 ring-violet-500/20">
            ...
            <div className="flex flex-col items-end gap-2">
              ...
              <span className="text-[10px] text-slate-500 font-mono">ID: {pendingUser._id || pendingUser.id}</span>
            </div>
          </div>
        )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-2.5">
              ...
              <Select value={selectedDept} onValueChange={setSelectedDept}>
                <SelectTrigger className="bg-[#0f111a] border-white/10 text-white h-12 rounded-xl focus:ring-violet-500 focus:ring-offset-0">
            ...
            {selectedRole === 'STUDENT' && (
              <div className="flex flex-col gap-2.5 animate-in slide-in-from-left-2">
                ...
                <Input 
                  ...
                  className="bg-[#0f111a] border-white/10 text-white h-12 rounded-xl focus:ring-violet-500 focus:ring-offset-0"
                />
              </div>
            )}
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Input 
                ...
                className="bg-[#0f111a] border-white/10 text-white h-12 rounded-xl font-mono focus:ring-violet-500 focus:ring-offset-0"
        ...
        <section className="pt-4 border-t border-violet-500/10">
          <div className="flex items-center justify-between p-4 rounded-2xl bg-[#0f111a] border border-violet-500/10">
            <div className="flex items-center gap-3">
      ...
      <Modal.Footer>
        <div className="flex flex-col-reverse sm:flex-row justify-between items-center w-full gap-4 bg-[#0f111a]/50 -mx-6 -mb-4 px-6 py-6 border-t border-violet-500/10">
          <Button variant="ghost" onClick={onClose} className="w-full sm:w-auto text-slate-400 hover:text-white hover:bg-violet-500/10">
            Cancel
          </Button>
