        ...
        <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex flex-col gap-2.5">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full h-12 pl-11 pr-10 rounded-xl bg-[#0f111a] border border-white/10 text-white text-sm font-medium appearance-none cursor-pointer outline-none focus:ring-2 focus:ring-indigo-500 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2 bg-[#0f111a] p-1 rounded-xl border border-white/10 h-12">
                  <button
                    ...
                    className={`flex-1 rounded-lg text-xs font-bold transition-all flex items-center justify-center gap-2 ${status === 'ACTIVE' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'text-slate-500 hover:text-slate-300'}`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 rounded-lg text-xs font-bold transition-all flex items-center justify-center gap-2 ${status === 'CLOSED' ? 'bg-red-500/10 text-red-400 border border-red-500/20' : 'text-slate-500 hover:text-slate-300'}`}
                  >
          ...
          <div className="pt-6 border-t border-white/5 flex justify-end gap-3">
            ...
            <Button 
              ...
              className="h-12 px-10 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 disabled:bg-slate-800 text-white font-bold shadow-lg shadow-indigo-500/20 transition-all flex items-center gap-2"
            >
